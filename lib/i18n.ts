...
const de={
  ...
  ui:{
    ...
    footer:{tagline:'Hospitality-Talent-Marktplatz für Österreich.',whatsappLabel:'Fragen? WhatsApp uns',colCandidates:'Kandidaten',colEmployers:'Arbeitgeber',colCompany:'Unternehmen',colLegal:'Rechtliches',linkFindJobs:'Stellen finden',linkRegister:'Registrieren',linkHowItWorks:"So funktioniert's",linkSalaryGuide:'Gehaltsguide',linkRegions:'Regionen',linkResources:'Ratgeber',linkForEmployers:'Für Arbeitgeber',linkPostVacancy:'Stelle inserieren',linkSuccessStories:'Erfolgsgeschichten',linkAbout:'Über uns',linkContact:'Kontakt',linkFaq:'FAQ',linkPrivacy:'Datenschutz',linkImprint:'Impressum',copyright:'© 2025 AlpenTalent · Hospitality Operating System',satisfaction:'Bewertung'}
  }
} as const;
const en:Dict={...de,
...
const cz:Dict={...de,
  ...
  ui:{...de.ui,
    ...
    footer:{tagline:'Práce v Rakousku pro Čechy a Slováky.',whatsappLabel:'Dotazy? Napište nám na WhatsApp',colCandidates:'Pro uchazeče',colEmployers:'Pro hotely',colCompany:'Firma',colLegal:'Právní',linkFindJobs:'Hledat práci',linkRegister:'Registrace',linkHowItWorks:'Jak to funguje',linkSalaryGuide:'Průvodce platy',linkRegions:'Regiony Rakouska',linkResources:'Průvodce AlpenLife',linkForEmployers:'Pro hotely',linkPostVacancy:'Zadat volné místo',linkSuccessStories:'Příběhy úspěchu',linkAbout:'O nás',linkContact:'Kontakt',linkFaq:'FAQ',linkPrivacy:'Ochrana osobních údajů',linkImprint:'Impressum',copyright:'© 2026 AlpenTalent · Práce v Rakousku',satisfaction:'spokojenost uchazečů'}
  }};
const app={
  de:{
    profile:{
