...
const de={
  ...
  homepage:{
    hero:{
      ...
      sub:'Vorqualifizierte Fachkräfte aus CZ/SK. Manuell geprüft. Zahlung erst bei Antritt.',
      primary:'Demo buchen',
  ...
  ui:{
    nav:{jobs:'Stellenangebote',consultation:'Beratung',forEmployers:'Für Arbeitgeber',howItWorks:"So funktioniert's",resources:'Ratgeber',about:'Über uns',login:'Anmelden',findOpportunities:'Demo buchen'},
...
const en:Dict={...de,
  ...
  ui:{...de.ui,
    nav:{jobs:'Jobs',consultation:'Consultation',forEmployers:'For Employers',howItWorks:'How it works',resources:'Resources',about:'About',login:'Login',findOpportunities:'Find opportunities'},
...
const cz:Dict={...de,
  ...
  ui:{...de.ui,
    nav:{jobs:'Otevřené pozice',consultation:'Konzultace',forEmployers:'Zaměstnavatelé',howItWorks:'Jak to funguje',resources:'Rádce',about:'O nás',login:'Přihlásit',findOpportunities:'Hledat práci'},
