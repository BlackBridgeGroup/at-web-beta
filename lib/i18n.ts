...
const de={
  ...
  hero:{eyebrow:'KI-gestütztes Recruiting · Österreich',title:'Personal schneller finden — mit KI.',subtitle:'Vorqualifizierte Fachkräfte aus CZ/SK. Sie zahlen erst, wenn jemand antritt. Kein Risiko.',primary:'Demo buchen',secondary:'Wie es funktioniert'},
  stats:[['Fix','Preis pro Antritt'],['Schnell','persönliche Rückmeldung'],['Null','Vorauszahlung'],['KI','gestütztes Matching']],
  trust:[['Kein Risiko','Fixgebühr bei Antritt — nur bei erfolgreichem Antritt. Keine versteckten Kosten.'],['Persönliche Rückmeldung','Von der Anfrage zur nächsten realistischen Recruiting-Aktion.'],['Geprüfte Qualität','Jeder Kandidat manuell geprüft. Keine Massen-CVs — nur echte Matches.']],
  ...
  homepage:{
    hero:{
      ...
      sub:'Vorqualifizierte Fachkräfte aus Mitteleuropa und international. Manuell geprüft. Zahlung erst bei Antritt.',
      primary:'Demo buchen',
    ...
    why:{
      ...
      tiles:[
        ...
        {title:'Schnelle Rückmeldung',body:'Von der Anfrage zur nächsten realistischen Recruiting-Aktion — ohne Massen-CVs.'},
    ...
    faq:{
      ...
      items:[
        ...
        ['Wie schnell liefert ihr?','Das hängt von Rolle, Region und Saison ab. Bei klaren Anforderungen starten wir sofort mit Suche, Prüfung und Ansprache.'],
    ...
    explore:{
      ...
      tiles:[
        ...
        {title:'Referenzen',body:'Verifizierte Fallstudien folgen, sobald Ergebnisse freigegeben sind.',href:'/de/success-stories',icon:'⭐'},
      ],
    },
    candidateBand:{
      heading:'Selbst auf Jobsuche?',
      sub:'AlpenTalent vermittelt auch Hospitality-Kandidaten aus Mitteleuropa und international, die in Österreich arbeiten wollen.',
  ...
  ui:{
    nav:{jobs:'Stellenangebote',consultation:'Beratung',forCandidates:'Für Kandidaten',forEmployers:'Für Arbeitgeber',howItWorks:"So funktioniert's",resources:'Ratgeber',about:'Über uns',login:'Anmelden',findOpportunities:'Demo buchen'},
    ...
    footer:{tagline:'Hospitality-Talent-Marktplatz für Österreich.',whatsappLabel:'Fragen? WhatsApp uns',colCandidates:'Kandidaten',colEmployers:'Arbeitgeber',colCompany:'Unternehmen',colLegal:'Rechtliches',linkFindJobs:'Stellen finden',linkConsultation:'Beratung',linkHowItWorks:"So funktioniert's",linkSalaryGuide:'Gehaltsguide',linkRegions:'Regionen',linkResources:'Ratgeber',linkForEmployers:'Für Arbeitgeber',linkPostVacancy:'Stelle inserieren',linkSuccessStories:'Erfolgsgeschichten',linkAbout:'Über uns',linkContact:'Kontakt',linkFaq:'FAQ',linkPrivacy:'Datenschutz',linkImprint:'Impressum',copyright:'© 2025 AlpenTalent · Hospitality Operating System',satisfaction:'Bewertung'}
  }
} as const;
const en:Dict={...de,
  ...
  hero:{eyebrow:'Hospitality Careers · Austria',title:'Build your hospitality career in Austria.',subtitle:'Reviewed employers. Salary orientation. Housing support. Free for candidates.',primary:'Find opportunities',secondary:'How it works'},
  stats:[['Fixed','Rate per placement'],['Fast','personal follow-up'],['Zero','Upfront cost'],['AI','powered matching']],
  trust:[['No Risk','Fixed success fee — only when someone starts. No hidden costs whatsoever.'],['Personal follow-up','From enquiry to the next realistic recruiting action.'],['Verified Quality','Every candidate manually screened. No bulk CVs — only real matches.']],
  ...
  homepage:{
    hero:{
      ...
      sub:'Reviewed employers. Salary orientation. Housing support. Free for candidates.',
    ...
    showcase:{
      ...
      items:[
        ...
        ['Hear back personally','A recruiter reviews your profile and follows up with the next realistic step.'],
    ...
    explore:{
      ...
      tiles:[
        {title:'Salary guide',body:'Indicative salary ranges for hospitality roles in Austria.',href:'/en/salary-guide',icon:'💶'},
        ...
        {title:'References',body:'Verified case studies will be added after outcomes are approved.',href:'/en/success-stories',icon:'⭐'},
      ],
    },
    faq:{
      ...
      items:[
        ...
        ['How long does it take?','We review each profile manually and follow up with the next realistic step as soon as there is a fit.'],
      ],
    },
    employerBand:{
  ...
  ui:{...de.ui,
    nav:{jobs:'Jobs',consultation:'Consultation',forCandidates:'For Candidates',forEmployers:'For Employers',howItWorks:'How it works',resources:'Resources',about:'About',login:'Login',findOpportunities:'Find opportunities'},
    ...
    footer:{tagline:'Hospitality talent marketplace for Austria.',whatsappLabel:'Questions? WhatsApp us',colCandidates:'Candidates',colEmployers:'Employers',colCompany:'Company',colLegal:'Legal',linkFindJobs:'Find jobs',linkConsultation:'Consultation',linkHowItWorks:'How it works',linkSalaryGuide:'Salary guide',linkRegions:'Regions',linkResources:'Resources',linkForEmployers:'For employers',linkPostVacancy:'Post a vacancy',linkSuccessStories:'References',linkAbout:'About',linkContact:'Contact',linkFaq:'FAQ',linkPrivacy:'Privacy Policy',linkImprint:'Imprint',copyright:'© 2025 AlpenTalent · Hospitality talent marketplace',satisfaction:'manual review'}
  }};
const cz:Dict={...de,
  ...
  stats:[['Zdarma','poplatek pro uchazeče'],['Profil','krátký dotazník'],['Osobně','ruční kontrola'],['AT','hotely a restaurace']],
  ...
  homepage:{
    ...
    explore:{
      ...
      tiles:[
        {title:'Průvodce platy',body:'Orientační platová rozpětí pro práci v Rakousku.',href:'/cz/salary-guide',icon:'💶'},
        ...
        {title:'Reference',body:'Ověřené příběhy doplníme po potvrzení výsledků.',href:'/cz/success-stories',icon:'⭐'},
      ],
    },
    faq:{
      ...
      items:[
        ...
        ['Jak rychle dostanu odpověď?','Záleží na roli, regionu a sezóně. Jakmile máme jasný profil, začínáme s kontrolou a párováním.'],
      ],
    },
    employerBand:{
      heading:'Hledáte personál pro váš hotel?',
      sub:'AlpenTalent nachází ověřené kandidáty ze střední Evropy i mezinárodně pro hotely v Rakousku.',
      cta:'Pro hotely →',
      href:'/de',
    },
  },
  ...
  ui:{...de.ui,
    nav:{jobs:'Otevřené pozice',consultation:'Konzultace',forCandidates:'Pro uchazeče',forEmployers:'Zaměstnavatelé',howItWorks:'Jak to funguje',resources:'Rádce',about:'O nás',login:'Přihlásit',findOpportunities:'Hledat práci'},
    ...
    footer:{tagline:'Práce v Rakousku pro Čechy a Slováky.',whatsappLabel:'Dotazy? Napište nám na WhatsApp',colCandidates:'Pro uchazeče',colEmployers:'Pro hotely',colCompany:'Firma',colLegal:'Právní',linkFindJobs:'Hledat práci',linkConsultation:'Konzultace',linkHowItWorks:'Jak to funguje',linkSalaryGuide:'Průvodce platy',linkRegions:'Regiony Rakouska',linkResources:'Průvodce AlpenLife',linkForEmployers:'Pro hotely',linkPostVacancy:'Zadat volné místo',linkSuccessStories:'Příběhy úspěchu',linkAbout:'O nás',linkContact:'Kontakt',linkFaq:'FAQ',linkPrivacy:'Ochrana osobních údajů',linkImprint:'Impressum',copyright:'© 2026 AlpenTalent · Práce v Rakousku',satisfaction:'spokojenost uchazečů'}
  }};
const app={
  de:{
    profile:{
