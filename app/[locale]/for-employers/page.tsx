...
const T: Record<string, Content> = {
  de: {
    ...
    faq: [
      ['Wie schnell findet ihr Kandidaten?', 'In der Regel innerhalb von 5–10 Werktagen bei Standardrollen. Dringende Vermittlungen lassen sich manchmal schneller arrangieren — sprich uns an.'],
      ...
      ['Kann ich ohne Registrierung eine Stelle ausschreiben?', 'Für die Ausschreibung brauchst du eine kurze Google-Anmeldung. Wir prüfen deine Hoteldaten innerhalb von 24 Stunden, bevor das Matching startet.'],
  ...
  cz: {
    ...
    faq: [
      ['Jak rychle najdete kandidáty?', 'Obvykle do 5–10 pracovních dnů u standardních pozic. Urgentní umístění lze někdy zařídit rychleji — ozvi se.'],
      ...
      ['Můžu zadat pozici bez registrace?', 'K zadání potřebuješ rychlé přihlášení přes Google. Údaje tvého hotelu ověříme do 24 hodin, než začne párování.'],
