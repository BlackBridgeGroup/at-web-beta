...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const titles: Record<Locale, string> = {
    en: 'Entry Consultation — Hospitality Career Consulting | AlpenTalent',
    de: 'Entry Consultation — Karriereberatung Hotellerie | AlpenTalent',
    cz: 'Vstupní konzultace — kariérní poradenství v hotelnictví | AlpenTalent',
  };
  ...
  return {
    ...
    alternates: {
      canonical: `https://alpentalent.com/${locale}/entry-consultation`,
      languages: { de: '/de/entry-consultation', cs: '/cz/entry-consultation', en: '/en/entry-consultation' },
    },
  };
}
...
const T: Record<string, Content> = {
  de: {
    ...
    steps: [
      ['01', 'Beratung buchen', 'Du buchst deine Entry Consultation und wir stimmen einen Termin ab.'],
    ...
    legalBody: 'Die Entry Consultation ist eine professionelle Beratungsleistung. Sie beinhaltet keine Garantie auf eine Anstellung und keine Garantie auf ein Visum oder eine Arbeitserlaubnis. Wir sind keine Rechts- oder Immigrationsberater. Der Recruiting-Erfolgshonorar wird von Arbeitgebern getragen — als Kandidat:in zahlst du nur die Beratung.',
  ...
  cz: {
    ...
    steps: [
      ['01', 'Rezervuj konzultaci', 'Rezervuješ si vstupní konzultaci a domluvíme termín.'],
    ...
    legalBody: 'Vstupní konzultace je profesionální poradenská služba. Nezahrnuje garanci zaměstnání ani garanci víza či pracovního povolení. Nejsme právní ani imigrační poradci. Náborový success fee platí zaměstnavatelé — jako uchazeč platíš pouze konzultaci.',
  ...
  en: {
    ...
    steps: [
      ['01', 'Book a consultation', 'You book your Entry Consultation and we agree a time.'],
    ...
    legalBody: 'The Entry Consultation is a professional consulting service. It does not include any guarantee of employment and no guarantee of a visa or work permit. We are not legal or immigration advisors. The recruitment success fee is paid by employers — as a candidate you pay only for the consultation.',
