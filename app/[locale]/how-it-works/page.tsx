      ...
      <div style={{ paddingBlock: 'clamp(48px, 8vw, 96px)', textAlign: 'center', background: 'var(--bg)' }}>
        <div className="at-container" style={{ maxWidth: 640 }}>
          ...
          <h1 className="at-display" style={{ margin: '0 0 var(--space-3)' }}>
            Five steps to your role in Austria.
          </h1>
          <p style={{ margin: 0, fontSize: '1.125rem', color: 'var(--text-muted)', lineHeight: 1.6 }}>
            No CV gymnastics. No headhunter fees. A clear path from first question to first day.
          </p>
        </div>
      </div>
      ...
      <section style={{ paddingBlock: 'var(--space-8)' }}>
        <div className="at-container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 'var(--space-3)' }}>
          <div className="at-card" style={{ padding: 'var(--space-4)', textAlign: 'center' }}>
            ...
            <h2 className="at-h2" style={{ margin: '0 0 8px' }}>I'm looking for a role</h2>
            <p style={{ color: 'var(--text-muted)', margin: '0 0 var(--space-3)' }}>Tell us about yourself and get matched to the right hotel.</p>
            <Link href={`/${locale}/jobs`} className="at-btn at-btn--primary">Find opportunities →</Link>
          </div>
          <div className="at-card" style={{ padding: 'var(--space-4)', textAlign: 'center', background: 'var(--at-alpine-green)', color: '#fff' }}>
            ...
            <h2 className="at-h2" style={{ margin: '0 0 8px', color: '#fff' }}>I'm hiring for my hotel</h2>
            <p style={{ color: 'rgba(255,255,255,0.8)', margin: '0 0 var(--space-3)' }}>Pre-matched hospitality talent, ready for Austria.</p>
            <Link href={`/${locale}/for-employers`} className="at-btn" style={{ background: '#fff', color: 'var(--at-alpine-green)', fontWeight: 700 }}>For employers →</Link>
          </div>
        </div>
      </section>
    </SiteShell>
